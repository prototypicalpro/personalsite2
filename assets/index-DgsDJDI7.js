(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&t(a)}).observe(document,{childList:!0,subtree:!0});function e(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(r){if(r.ep)return;r.ep=!0;const n=e(r);fetch(r.href,n)}})();const Je=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,Vi="8.50.0",Ve=globalThis;function Cn(i,e,t){const r=t||Ve,n=r.__SENTRY__=r.__SENTRY__||{},a=n[Vi]=n[Vi]||{};return a[i]||(a[i]=e())}const Wi=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,Ah="Sentry Logger ",Pn=["debug","info","warn","error","log","assert","trace"],Ln={};function ji(i){if(!("console"in Ve))return i();const e=Ve.console,t={},r=Object.keys(Ln);r.forEach(n=>{const a=Ln[n];t[n]=e[n],e[n]=a});try{return i()}finally{r.forEach(n=>{e[n]=t[n]})}}function Rh(){let i=!1;const e={enable:()=>{i=!0},disable:()=>{i=!1},isEnabled:()=>i};return Wi?Pn.forEach(t=>{e[t]=(...r)=>{i&&ji(()=>{Ve.console[t](`${Ah}[${t}]:`,...r)})}}):Pn.forEach(t=>{e[t]=()=>{}}),e}const Me=Cn("logger",Rh),ll=50,Xi="?",cl=/\(error: (.*)\)/,ul=/captureMessage|captureException/;function hl(...i){const e=i.sort((t,r)=>t[0]-r[0]).map(t=>t[1]);return(t,r=0,n=0)=>{const a=[],s=t.split(`
`);for(let o=r;o<s.length;o++){const l=s[o];if(l.length>1024)continue;const c=cl.test(l)?l.replace(cl,"$1"):l;if(!c.match(/\S*Error: /)){for(const u of e){const h=u(c);if(h){a.push(h);break}}if(a.length>=ll+n)break}}return Ph(a.slice(n))}}function Ch(i){return Array.isArray(i)?hl(...i):i}function Ph(i){if(!i.length)return[];const e=Array.from(i);return/sentryWrapped/.test(Un(e).function||"")&&e.pop(),e.reverse(),ul.test(Un(e).function||"")&&(e.pop(),ul.test(Un(e).function||"")&&e.pop()),e.slice(0,ll).map(t=>({...t,filename:t.filename||Un(e).filename,function:t.function||Xi}))}function Un(i){return i[i.length-1]||{}}const Ba="<anonymous>";function Ti(i){try{return!i||typeof i!="function"?Ba:i.name||Ba}catch{return Ba}}function dl(i){const e=i.exception;if(e){const t=[];try{return e.values.forEach(r=>{r.stacktrace.frames&&t.push(...r.stacktrace.frames)}),t}catch{return}}}const Dn={},pl={};function qi(i,e){Dn[i]=Dn[i]||[],Dn[i].push(e)}function Yi(i,e){if(!pl[i]){pl[i]=!0;try{e()}catch(t){Wi&&Me.error(`Error while instrumenting ${i}`,t)}}}function $t(i,e){const t=i&&Dn[i];if(t)for(const r of t)try{r(e)}catch(n){Wi&&Me.error(`Error while triggering instrumentation handler.
Type: ${i}
Name: ${Ti(r)}
Error:`,n)}}let ka=null;function Lh(i){const e="error";qi(e,i),Yi(e,Uh)}function Uh(){ka=Ve.onerror,Ve.onerror=function(i,e,t,r,n){return $t("error",{column:r,error:n,line:t,msg:i,url:e}),ka?ka.apply(this,arguments):!1},Ve.onerror.__SENTRY_INSTRUMENTED__=!0}let Ha=null;function Dh(i){const e="unhandledrejection";qi(e,i),Yi(e,Ih)}function Ih(){Ha=Ve.onunhandledrejection,Ve.onunhandledrejection=function(i){return $t("unhandledrejection",i),Ha?Ha.apply(this,arguments):!0},Ve.onunhandledrejection.__SENTRY_INSTRUMENTED__=!0}function In(){return Ga(Ve),Ve}function Ga(i){const e=i.__SENTRY__=i.__SENTRY__||{};return e.version=e.version||Vi,e[Vi]=e[Vi]||{}}const fl=Object.prototype.toString;function Va(i){switch(fl.call(i)){case"[object Error]":case"[object Exception]":case"[object DOMException]":case"[object WebAssembly.Exception]":return!0;default:return $i(i,Error)}}function vr(i,e){return fl.call(i)===`[object ${e}]`}function ml(i){return vr(i,"ErrorEvent")}function gl(i){return vr(i,"DOMError")}function Nh(i){return vr(i,"DOMException")}function oi(i){return vr(i,"String")}function Wa(i){return typeof i=="object"&&i!==null&&"__sentry_template_string__"in i&&"__sentry_template_values__"in i}function ja(i){return i===null||Wa(i)||typeof i!="object"&&typeof i!="function"}function xr(i){return vr(i,"Object")}function Nn(i){return typeof Event<"u"&&$i(i,Event)}function Oh(i){return typeof Element<"u"&&$i(i,Element)}function Fh(i){return vr(i,"RegExp")}function On(i){return!!(i&&i.then&&typeof i.then=="function")}function zh(i){return xr(i)&&"nativeEvent"in i&&"preventDefault"in i&&"stopPropagation"in i}function $i(i,e){try{return i instanceof e}catch{return!1}}function _l(i){return!!(typeof i=="object"&&i!==null&&(i.__isVue||i._isVue))}const Xa=Ve,Bh=80;function vl(i,e={}){if(!i)return"<unknown>";try{let t=i;const r=5,n=[];let a=0,s=0;const o=" > ",l=o.length;let c;const u=Array.isArray(e)?e:e.keyAttrs,h=!Array.isArray(e)&&e.maxStringLength||Bh;for(;t&&a++<r&&(c=kh(t,u),!(c==="html"||a>1&&s+n.length*l+c.length>=h));)n.push(c),s+=c.length,t=t.parentNode;return n.reverse().join(o)}catch{return"<unknown>"}}function kh(i,e){const t=i,r=[];if(!t||!t.tagName)return"";if(Xa.HTMLElement&&t instanceof HTMLElement&&t.dataset){if(t.dataset.sentryComponent)return t.dataset.sentryComponent;if(t.dataset.sentryElement)return t.dataset.sentryElement}r.push(t.tagName.toLowerCase());const n=e&&e.length?e.filter(s=>t.getAttribute(s)).map(s=>[s,t.getAttribute(s)]):null;if(n&&n.length)n.forEach(s=>{r.push(`[${s[0]}="${s[1]}"]`)});else{t.id&&r.push(`#${t.id}`);const s=t.className;if(s&&oi(s)){const o=s.split(/\s+/);for(const l of o)r.push(`.${l}`)}}const a=["aria-label","type","name","title","alt"];for(const s of a){const o=t.getAttribute(s);o&&r.push(`[${s}="${o}"]`)}return r.join("")}function Hh(){try{return Xa.document.location.href}catch{return""}}function Gh(i){if(!Xa.HTMLElement)return null;let e=i;const t=5;for(let r=0;r<t;r++){if(!e)return null;if(e instanceof HTMLElement){if(e.dataset.sentryComponent)return e.dataset.sentryComponent;if(e.dataset.sentryElement)return e.dataset.sentryElement}e=e.parentNode}return null}function Sr(i,e=0){return typeof i!="string"||e===0||i.length<=e?i:`${i.slice(0,e)}...`}function Fn(i,e){if(!Array.isArray(i))return"";const t=[];for(let r=0;r<i.length;r++){const n=i[r];try{_l(n)?t.push("[VueViewModel]"):t.push(String(n))}catch{t.push("[value cannot be serialized]")}}return t.join(e)}function Vh(i,e,t=!1){return oi(i)?Fh(e)?e.test(i):oi(e)?t?i===e:i.includes(e):!1:!1}function zn(i,e=[],t=!1){return e.some(r=>Vh(i,r,t))}function Lt(i,e,t){if(!(e in i))return;const r=i[e],n=t(r);typeof n=="function"&&xl(n,r);try{i[e]=n}catch{Wi&&Me.log(`Failed to replace method "${e}" in object`,i)}}function Ki(i,e,t){try{Object.defineProperty(i,e,{value:t,writable:!0,configurable:!0})}catch{Wi&&Me.log(`Failed to add non-enumerable property "${e}" to object`,i)}}function xl(i,e){try{const t=e.prototype||{};i.prototype=e.prototype=t,Ki(i,"__sentry_original__",e)}catch{}}function qa(i){return i.__sentry_original__}function Sl(i){if(Va(i))return{message:i.message,name:i.name,stack:i.stack,...Ml(i)};if(Nn(i)){const e={type:i.type,target:yl(i.target),currentTarget:yl(i.currentTarget),...Ml(i)};return typeof CustomEvent<"u"&&$i(i,CustomEvent)&&(e.detail=i.detail),e}else return i}function yl(i){try{return Oh(i)?vl(i):Object.prototype.toString.call(i)}catch{return"<unknown>"}}function Ml(i){if(typeof i=="object"&&i!==null){const e={};for(const t in i)Object.prototype.hasOwnProperty.call(i,t)&&(e[t]=i[t]);return e}else return{}}function Wh(i,e=40){const t=Object.keys(Sl(i));t.sort();const r=t[0];if(!r)return"[object has no keys]";if(r.length>=e)return Sr(r,e);for(let n=t.length;n>0;n--){const a=t.slice(0,n).join(", ");if(!(a.length>e))return n===t.length?a:Sr(a,e)}return""}function zt(i){return Ya(i,new Map)}function Ya(i,e){if(jh(i)){const t=e.get(i);if(t!==void 0)return t;const r={};e.set(i,r);for(const n of Object.getOwnPropertyNames(i))typeof i[n]<"u"&&(r[n]=Ya(i[n],e));return r}if(Array.isArray(i)){const t=e.get(i);if(t!==void 0)return t;const r=[];return e.set(i,r),i.forEach(n=>{r.push(Ya(n,e))}),r}return i}function jh(i){if(!xr(i))return!1;try{const e=Object.getPrototypeOf(i).constructor.name;return!e||e==="Object"}catch{return!0}}const El=1e3;function Qr(){return Date.now()/El}function Xh(){const{performance:i}=Ve;if(!i||!i.now)return Qr;const e=Date.now()-i.now(),t=i.timeOrigin==null?e:i.timeOrigin;return()=>(t+i.now())/El}const li=Xh();(()=>{const{performance:i}=Ve;if(!i||!i.now)return;const e=3600*1e3,t=i.now(),r=Date.now(),n=i.timeOrigin?Math.abs(i.timeOrigin+t-r):e,a=n<e,s=i.timing&&i.timing.navigationStart,o=typeof s=="number"?Math.abs(s+t-r):e,l=o<e;return a||l?n<=o?i.timeOrigin:s:r})();function Bt(){const i=Ve,e=i.crypto||i.msCrypto;let t=()=>Math.random()*16;try{if(e&&e.randomUUID)return e.randomUUID().replace(/-/g,"");e&&e.getRandomValues&&(t=()=>{const r=new Uint8Array(1);return e.getRandomValues(r),r[0]})}catch{}return("10000000100040008000"+1e11).replace(/[018]/g,r=>(r^(t()&15)>>r/4).toString(16))}function bl(i){return i.exception&&i.exception.values?i.exception.values[0]:void 0}function wi(i){const{message:e,event_id:t}=i;if(e)return e;const r=bl(i);return r?r.type&&r.value?`${r.type}: ${r.value}`:r.type||r.value||t||"<unknown>":t||"<unknown>"}function $a(i,e,t){const r=i.exception=i.exception||{},n=r.values=r.values||[],a=n[0]=n[0]||{};a.value||(a.value=e||""),a.type||(a.type="Error")}function Zi(i,e){const t=bl(i);if(!t)return;const r={type:"generic",handled:!0},n=t.mechanism;if(t.mechanism={...r,...n,...e},e&&"data"in e){const a={...n&&n.data,...e.data};t.mechanism.data=a}}function Tl(i){if(qh(i))return!0;try{Ki(i,"__sentry_captured__",!0)}catch{}return!1}function qh(i){try{return i.__sentry_captured__}catch{}}var ci;(function(i){i[i.PENDING=0]="PENDING";const e=1;i[i.RESOLVED=e]="RESOLVED";const t=2;i[i.REJECTED=t]="REJECTED"})(ci||(ci={}));function Ji(i){return new jt(e=>{e(i)})}function Bn(i){return new jt((e,t)=>{t(i)})}class jt{constructor(e){jt.prototype.__init.call(this),jt.prototype.__init2.call(this),jt.prototype.__init3.call(this),jt.prototype.__init4.call(this),this._state=ci.PENDING,this._handlers=[];try{e(this._resolve,this._reject)}catch(t){this._reject(t)}}then(e,t){return new jt((r,n)=>{this._handlers.push([!1,a=>{if(!e)r(a);else try{r(e(a))}catch(s){n(s)}},a=>{if(!t)n(a);else try{r(t(a))}catch(s){n(s)}}]),this._executeHandlers()})}catch(e){return this.then(t=>t,e)}finally(e){return new jt((t,r)=>{let n,a;return this.then(s=>{a=!1,n=s,e&&e()},s=>{a=!0,n=s,e&&e()}).then(()=>{if(a){r(n);return}t(n)})})}__init(){this._resolve=e=>{this._setResult(ci.RESOLVED,e)}}__init2(){this._reject=e=>{this._setResult(ci.REJECTED,e)}}__init3(){this._setResult=(e,t)=>{if(this._state===ci.PENDING){if(On(t)){t.then(this._resolve,this._reject);return}this._state=e,this._value=t,this._executeHandlers()}}}__init4(){this._executeHandlers=()=>{if(this._state===ci.PENDING)return;const e=this._handlers.slice();this._handlers=[],e.forEach(t=>{t[0]||(this._state===ci.RESOLVED&&t[1](this._value),this._state===ci.REJECTED&&t[2](this._value),t[0]=!0)})}}}function Yh(i){const e=li(),t={sid:Bt(),init:!0,timestamp:e,started:e,duration:0,status:"ok",errors:0,ignoreDuration:!1,toJSON:()=>Kh(t)};return yr(t,i),t}function yr(i,e={}){if(e.user&&(!i.ipAddress&&e.user.ip_address&&(i.ipAddress=e.user.ip_address),!i.did&&!e.did&&(i.did=e.user.id||e.user.email||e.user.username)),i.timestamp=e.timestamp||li(),e.abnormal_mechanism&&(i.abnormal_mechanism=e.abnormal_mechanism),e.ignoreDuration&&(i.ignoreDuration=e.ignoreDuration),e.sid&&(i.sid=e.sid.length===32?e.sid:Bt()),e.init!==void 0&&(i.init=e.init),!i.did&&e.did&&(i.did=`${e.did}`),typeof e.started=="number"&&(i.started=e.started),i.ignoreDuration)i.duration=void 0;else if(typeof e.duration=="number")i.duration=e.duration;else{const t=i.timestamp-i.started;i.duration=t>=0?t:0}e.release&&(i.release=e.release),e.environment&&(i.environment=e.environment),!i.ipAddress&&e.ipAddress&&(i.ipAddress=e.ipAddress),!i.userAgent&&e.userAgent&&(i.userAgent=e.userAgent),typeof e.errors=="number"&&(i.errors=e.errors),e.status&&(i.status=e.status)}function $h(i,e){let t={};i.status==="ok"&&(t={status:"exited"}),yr(i,t)}function Kh(i){return zt({sid:`${i.sid}`,init:i.init,started:new Date(i.started*1e3).toISOString(),timestamp:new Date(i.timestamp*1e3).toISOString(),status:i.status,errors:i.errors,did:typeof i.did=="number"||typeof i.did=="string"?`${i.did}`:void 0,duration:i.duration,abnormal_mechanism:i.abnormal_mechanism,attrs:{release:i.release,environment:i.environment,ip_address:i.ipAddress,user_agent:i.userAgent}})}function wl(){return Bt()}function Ka(){return Bt().substring(16)}function kn(i,e,t=2){if(!e||typeof e!="object"||t<=0)return e;if(i&&e&&Object.keys(e).length===0)return i;const r={...i};for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&(r[n]=kn(r[n],e[n],t-1));return r}const Za="_sentrySpan";function Al(i,e){e?Ki(i,Za,e):delete i[Za]}function Rl(i){return i[Za]}const Zh=100;class Qo{constructor(){this._notifyingListeners=!1,this._scopeListeners=[],this._eventProcessors=[],this._breadcrumbs=[],this._attachments=[],this._user={},this._tags={},this._extra={},this._contexts={},this._sdkProcessingMetadata={},this._propagationContext={traceId:wl(),spanId:Ka()}}clone(){const e=new Qo;return e._breadcrumbs=[...this._breadcrumbs],e._tags={...this._tags},e._extra={...this._extra},e._contexts={...this._contexts},this._contexts.flags&&(e._contexts.flags={values:[...this._contexts.flags.values]}),e._user=this._user,e._level=this._level,e._session=this._session,e._transactionName=this._transactionName,e._fingerprint=this._fingerprint,e._eventProcessors=[...this._eventProcessors],e._requestSession=this._requestSession,e._attachments=[...this._attachments],e._sdkProcessingMetadata={...this._sdkProcessingMetadata},e._propagationContext={...this._propagationContext},e._client=this._client,e._lastEventId=this._lastEventId,Al(e,Rl(this)),e}setClient(e){this._client=e}setLastEventId(e){this._lastEventId=e}getClient(){return this._client}lastEventId(){return this._lastEventId}addScopeListener(e){this._scopeListeners.push(e)}addEventProcessor(e){return this._eventProcessors.push(e),this}setUser(e){return this._user=e||{email:void 0,id:void 0,ip_address:void 0,username:void 0},this._session&&yr(this._session,{user:e}),this._notifyScopeListeners(),this}getUser(){return this._user}getRequestSession(){return this._requestSession}setRequestSession(e){return this._requestSession=e,this}setTags(e){return this._tags={...this._tags,...e},this._notifyScopeListeners(),this}setTag(e,t){return this._tags={...this._tags,[e]:t},this._notifyScopeListeners(),this}setExtras(e){return this._extra={...this._extra,...e},this._notifyScopeListeners(),this}setExtra(e,t){return this._extra={...this._extra,[e]:t},this._notifyScopeListeners(),this}setFingerprint(e){return this._fingerprint=e,this._notifyScopeListeners(),this}setLevel(e){return this._level=e,this._notifyScopeListeners(),this}setTransactionName(e){return this._transactionName=e,this._notifyScopeListeners(),this}setContext(e,t){return t===null?delete this._contexts[e]:this._contexts[e]=t,this._notifyScopeListeners(),this}setSession(e){return e?this._session=e:delete this._session,this._notifyScopeListeners(),this}getSession(){return this._session}update(e){if(!e)return this;const t=typeof e=="function"?e(this):e,[r,n]=t instanceof Ai?[t.getScopeData(),t.getRequestSession()]:xr(t)?[e,e.requestSession]:[],{tags:a,extra:s,user:o,contexts:l,level:c,fingerprint:u=[],propagationContext:h}=r||{};return this._tags={...this._tags,...a},this._extra={...this._extra,...s},this._contexts={...this._contexts,...l},o&&Object.keys(o).length&&(this._user=o),c&&(this._level=c),u.length&&(this._fingerprint=u),h&&(this._propagationContext=h),n&&(this._requestSession=n),this}clear(){return this._breadcrumbs=[],this._tags={},this._extra={},this._user={},this._contexts={},this._level=void 0,this._transactionName=void 0,this._fingerprint=void 0,this._requestSession=void 0,this._session=void 0,Al(this,void 0),this._attachments=[],this.setPropagationContext({traceId:wl()}),this._notifyScopeListeners(),this}addBreadcrumb(e,t){const r=typeof t=="number"?t:Zh;if(r<=0)return this;const n={timestamp:Qr(),...e},a=this._breadcrumbs;return a.push(n),this._breadcrumbs=a.length>r?a.slice(-r):a,this._notifyScopeListeners(),this}getLastBreadcrumb(){return this._breadcrumbs[this._breadcrumbs.length-1]}clearBreadcrumbs(){return this._breadcrumbs=[],this._notifyScopeListeners(),this}addAttachment(e){return this._attachments.push(e),this}clearAttachments(){return this._attachments=[],this}getScopeData(){return{breadcrumbs:this._breadcrumbs,attachments:this._attachments,contexts:this._contexts,tags:this._tags,extra:this._extra,user:this._user,level:this._level,fingerprint:this._fingerprint||[],eventProcessors:this._eventProcessors,propagationContext:this._propagationContext,sdkProcessingMetadata:this._sdkProcessingMetadata,transactionName:this._transactionName,span:Rl(this)}}setSDKProcessingMetadata(e){return this._sdkProcessingMetadata=kn(this._sdkProcessingMetadata,e,2),this}setPropagationContext(e){return this._propagationContext={spanId:Ka(),...e},this}getPropagationContext(){return this._propagationContext}captureException(e,t){const r=t&&t.event_id?t.event_id:Bt();if(!this._client)return Me.warn("No client configured on scope - will not capture exception!"),r;const n=new Error("Sentry syntheticException");return this._client.captureException(e,{originalException:e,syntheticException:n,...t,event_id:r},this),r}captureMessage(e,t,r){const n=r&&r.event_id?r.event_id:Bt();if(!this._client)return Me.warn("No client configured on scope - will not capture message!"),n;const a=new Error(e);return this._client.captureMessage(e,t,{originalException:e,syntheticException:a,...r,event_id:n},this),n}captureEvent(e,t){const r=t&&t.event_id?t.event_id:Bt();return this._client?(this._client.captureEvent(e,{...t,event_id:r},this),r):(Me.warn("No client configured on scope - will not capture event!"),r)}_notifyScopeListeners(){this._notifyingListeners||(this._notifyingListeners=!0,this._scopeListeners.forEach(e=>{e(this)}),this._notifyingListeners=!1)}}const Ai=Qo;function Jh(){return Cn("defaultCurrentScope",()=>new Ai)}function Qh(){return Cn("defaultIsolationScope",()=>new Ai)}class ed{constructor(e,t){let r;e?r=e:r=new Ai;let n;t?n=t:n=new Ai,this._stack=[{scope:r}],this._isolationScope=n}withScope(e){const t=this._pushScope();let r;try{r=e(t)}catch(n){throw this._popScope(),n}return On(r)?r.then(n=>(this._popScope(),n),n=>{throw this._popScope(),n}):(this._popScope(),r)}getClient(){return this.getStackTop().client}getScope(){return this.getStackTop().scope}getIsolationScope(){return this._isolationScope}getStackTop(){return this._stack[this._stack.length-1]}_pushScope(){const e=this.getScope().clone();return this._stack.push({client:this.getClient(),scope:e}),e}_popScope(){return this._stack.length<=1?!1:!!this._stack.pop()}}function Mr(){const i=In(),e=Ga(i);return e.stack=e.stack||new ed(Jh(),Qh())}function td(i){return Mr().withScope(i)}function id(i,e){const t=Mr();return t.withScope(()=>(t.getStackTop().scope=i,e(i)))}function Cl(i){return Mr().withScope(()=>i(Mr().getIsolationScope()))}function rd(){return{withIsolationScope:Cl,withScope:td,withSetScope:id,withSetIsolationScope:(i,e)=>Cl(e),getCurrentScope:()=>Mr().getScope(),getIsolationScope:()=>Mr().getIsolationScope()}}function Ja(i){const e=Ga(i);return e.acs?e.acs:rd()}function ei(){const i=In();return Ja(i).getCurrentScope()}function en(){const i=In();return Ja(i).getIsolationScope()}function nd(){return Cn("globalScope",()=>new Ai)}function Pl(...i){const e=In(),t=Ja(e);if(i.length===2){const[r,n]=i;return r?t.withSetScope(r,n):t.withScope(n)}return t.withScope(i[0])}function _t(){return ei().getClient()}function ad(i){const e=i.getPropagationContext(),{traceId:t,spanId:r,parentSpanId:n}=e;return zt({trace_id:t,span_id:r,parent_span_id:n})}const sd="_sentryMetrics";function od(i){const e=i[sd];if(!e)return;const t={};for(const[,[r,n]]of e)(t[r]||(t[r]=[])).push(zt(n));return t}const ld="sentry.source",cd="sentry.sample_rate",ud="sentry.op",hd="sentry.origin",dd=0,pd=1,fd="sentry-",md=/^sentry-/;function gd(i){const e=_d(i);if(!e)return;const t=Object.entries(e).reduce((r,[n,a])=>{if(n.match(md)){const s=n.slice(fd.length);r[s]=a}return r},{});if(Object.keys(t).length>0)return t}function _d(i){if(!(!i||!oi(i)&&!Array.isArray(i)))return Array.isArray(i)?i.reduce((e,t)=>{const r=Ll(t);return Object.entries(r).forEach(([n,a])=>{e[n]=a}),e},{}):Ll(i)}function Ll(i){return i.split(",").map(e=>e.split("=").map(t=>decodeURIComponent(t.trim()))).reduce((e,[t,r])=>(t&&r&&(e[t]=r),e),{})}const vd=1;let Ul=!1;function xd(i){const{spanId:e,traceId:t,isRemote:r}=i.spanContext(),n=r?e:Qa(i).parent_span_id,a=r?Ka():e;return zt({parent_span_id:n,span_id:a,trace_id:t})}function Dl(i){return typeof i=="number"?Il(i):Array.isArray(i)?i[0]+i[1]/1e9:i instanceof Date?Il(i.getTime()):li()}function Il(i){return i>9999999999?i/1e3:i}function Qa(i){if(yd(i))return i.getSpanJSON();try{const{spanId:e,traceId:t}=i.spanContext();if(Sd(i)){const{attributes:r,startTime:n,name:a,endTime:s,parentSpanId:o,status:l}=i;return zt({span_id:e,trace_id:t,data:r,description:a,parent_span_id:o,start_timestamp:Dl(n),timestamp:Dl(s)||void 0,status:Ed(l),op:r[ud],origin:r[hd],_metrics_summary:od(i)})}return{span_id:e,trace_id:t}}catch{return{}}}function Sd(i){const e=i;return!!e.attributes&&!!e.startTime&&!!e.name&&!!e.endTime&&!!e.status}function yd(i){return typeof i.getSpanJSON=="function"}function Md(i){const{traceFlags:e}=i.spanContext();return e===vd}function Ed(i){if(!(!i||i.code===dd))return i.code===pd?"ok":i.message||"unknown_error"}const bd="_sentryRootSpan";function Nl(i){return i[bd]||i}function Td(){Ul||(ji(()=>{console.warn("[Sentry] Deprecation warning: Returning null from `beforeSendSpan` will be disallowed from SDK version 9.0.0 onwards. The callback will only support mutating spans. To drop certain spans, configure the respective integrations directly.")}),Ul=!0)}function wd(i){if(typeof __SENTRY_TRACING__=="boolean"&&!__SENTRY_TRACING__)return!1;const e=_t(),t=e&&e.getOptions();return!!t&&(t.enableTracing||"tracesSampleRate"in t||"tracesSampler"in t)}const es="production",Ad="_frozenDsc";function Ol(i,e){const t=e.getOptions(),{publicKey:r}=e.getDsn()||{},n=zt({environment:t.environment||es,release:t.release,public_key:r,trace_id:i});return e.emit("createDsc",n),n}function Rd(i,e){const t=e.getPropagationContext();return t.dsc||Ol(t.traceId,i)}function Cd(i){const e=_t();if(!e)return{};const t=Nl(i),r=t[Ad];if(r)return r;const n=t.spanContext().traceState,a=n&&n.get("sentry.dsc"),s=a&&gd(a);if(s)return s;const o=Ol(i.spanContext().traceId,e),l=Qa(t),c=l.data||{},u=c[cd];u!=null&&(o.sample_rate=`${u}`);const h=c[ld],d=l.description;return h!=="url"&&d&&(o.transaction=d),wd()&&(o.sampled=String(Md(t))),e.emit("createDsc",o,t),o}function Pd(i){if(typeof i=="boolean")return Number(i);const e=typeof i=="string"?parseFloat(i):i;if(typeof e!="number"||isNaN(e)||e<0||e>1){Je&&Me.warn(`[Tracing] Given sample rate is invalid. Sample rate must be a boolean or a number between 0 and 1. Got ${JSON.stringify(i)} of type ${JSON.stringify(typeof i)}.`);return}return e}const Ld=/^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)([\w.-]+)(?::(\d+))?\/(.+)/;function Ud(i){return i==="http"||i==="https"}function Hn(i,e=!1){const{host:t,path:r,pass:n,port:a,projectId:s,protocol:o,publicKey:l}=i;return`${o}://${l}${e&&n?`:${n}`:""}@${t}${a?`:${a}`:""}/${r&&`${r}/`}${s}`}function Dd(i){const e=Ld.exec(i);if(!e){ji(()=>{console.error(`Invalid Sentry Dsn: ${i}`)});return}const[t,r,n="",a="",s="",o=""]=e.slice(1);let l="",c=o;const u=c.split("/");if(u.length>1&&(l=u.slice(0,-1).join("/"),c=u.pop()),c){const h=c.match(/^\d+/);h&&(c=h[0])}return Fl({host:a,pass:n,path:l,projectId:c,port:s,protocol:t,publicKey:r})}function Fl(i){return{protocol:i.protocol,publicKey:i.publicKey||"",pass:i.pass||"",host:i.host,port:i.port||"",path:i.path||"",projectId:i.projectId}}function Id(i){if(!Wi)return!0;const{port:e,projectId:t,protocol:r}=i;return["protocol","publicKey","host","projectId"].find(n=>i[n]?!1:(Me.error(`Invalid Sentry Dsn: ${n} missing`),!0))?!1:t.match(/^\d+$/)?Ud(r)?e&&isNaN(parseInt(e,10))?(Me.error(`Invalid Sentry Dsn: Invalid port ${e}`),!1):!0:(Me.error(`Invalid Sentry Dsn: Invalid protocol ${r}`),!1):(Me.error(`Invalid Sentry Dsn: Invalid projectId ${t}`),!1)}function Nd(i){const e=typeof i=="string"?Dd(i):Fl(i);if(!(!e||!Id(e)))return e}function Od(){const i=typeof WeakSet=="function",e=i?new WeakSet:[];function t(n){if(i)return e.has(n)?!0:(e.add(n),!1);for(let a=0;a<e.length;a++)if(e[a]===n)return!0;return e.push(n),!1}function r(n){if(i)e.delete(n);else for(let a=0;a<e.length;a++)if(e[a]===n){e.splice(a,1);break}}return[t,r]}function ui(i,e=100,t=1/0){try{return ts("",i,e,t)}catch(r){return{ERROR:`**non-serializable** (${r})`}}}function zl(i,e=3,t=100*1024){const r=ui(i,e);return kd(r)>t?zl(i,e-1,t):r}function ts(i,e,t=1/0,r=1/0,n=Od()){const[a,s]=n;if(e==null||["boolean","string"].includes(typeof e)||typeof e=="number"&&Number.isFinite(e))return e;const o=Fd(i,e);if(!o.startsWith("[object "))return o;if(e.__sentry_skip_normalization__)return e;const l=typeof e.__sentry_override_normalization_depth__=="number"?e.__sentry_override_normalization_depth__:t;if(l===0)return o.replace("object ","");if(a(e))return"[Circular ~]";const c=e;if(c&&typeof c.toJSON=="function")try{const f=c.toJSON();return ts("",f,l-1,r,n)}catch{}const u=Array.isArray(e)?[]:{};let h=0;const d=Sl(e);for(const f in d){if(!Object.prototype.hasOwnProperty.call(d,f))continue;if(h>=r){u[f]="[MaxProperties ~]";break}const v=d[f];u[f]=ts(f,v,l-1,r,n),h++}return s(e),u}function Fd(i,e){try{if(i==="domain"&&e&&typeof e=="object"&&e._events)return"[Domain]";if(i==="domainEmitter")return"[DomainEmitter]";if(typeof global<"u"&&e===global)return"[Global]";if(typeof window<"u"&&e===window)return"[Window]";if(typeof document<"u"&&e===document)return"[Document]";if(_l(e))return"[VueViewModel]";if(zh(e))return"[SyntheticEvent]";if(typeof e=="number"&&!Number.isFinite(e))return`[${e}]`;if(typeof e=="function")return`[Function: ${Ti(e)}]`;if(typeof e=="symbol")return`[${String(e)}]`;if(typeof e=="bigint")return`[BigInt: ${String(e)}]`;const t=zd(e);return/^HTML(\w*)Element$/.test(t)?`[HTMLElement: ${t}]`:`[object ${t}]`}catch(t){return`**non-serializable** (${t})`}}function zd(i){const e=Object.getPrototypeOf(i);return e?e.constructor.name:"null prototype"}function Bd(i){return~-encodeURI(i).split(/%..|./).length}function kd(i){return Bd(JSON.stringify(i))}function tn(i,e=[]){return[i,e]}function Hd(i,e){const[t,r]=i;return[t,[...r,e]]}function Bl(i,e){const t=i[1];for(const r of t){const n=r[0].type;if(e(r,n))return!0}return!1}function is(i){return Ve.__SENTRY__&&Ve.__SENTRY__.encodePolyfill?Ve.__SENTRY__.encodePolyfill(i):new TextEncoder().encode(i)}function Gd(i){const[e,t]=i;let r=JSON.stringify(e);function n(a){typeof r=="string"?r=typeof a=="string"?r+a:[is(r),a]:r.push(typeof a=="string"?is(a):a)}for(const a of t){const[s,o]=a;if(n(`
${JSON.stringify(s)}
`),typeof o=="string"||o instanceof Uint8Array)n(o);else{let l;try{l=JSON.stringify(o)}catch{l=JSON.stringify(ui(o))}n(l)}}return typeof r=="string"?r:Vd(r)}function Vd(i){const e=i.reduce((n,a)=>n+a.length,0),t=new Uint8Array(e);let r=0;for(const n of i)t.set(n,r),r+=n.length;return t}function Wd(i){const e=typeof i.data=="string"?is(i.data):i.data;return[zt({type:"attachment",length:e.length,filename:i.filename,content_type:i.contentType,attachment_type:i.attachmentType}),e]}const jd={session:"session",sessions:"session",attachment:"attachment",transaction:"transaction",event:"error",client_report:"internal",user_report:"default",profile:"profile",profile_chunk:"profile",replay_event:"replay",replay_recording:"replay",check_in:"monitor",feedback:"feedback",span:"span",statsd:"metric_bucket",raw_security:"security"};function kl(i){return jd[i]}function Hl(i){if(!i||!i.sdk)return;const{name:e,version:t}=i.sdk;return{name:e,version:t}}function Xd(i,e,t,r){const n=i.sdkProcessingMetadata&&i.sdkProcessingMetadata.dynamicSamplingContext;return{event_id:i.event_id,sent_at:new Date().toISOString(),...e&&{sdk:e},...!!t&&r&&{dsn:Hn(r)},...n&&{trace:zt({...n})}}}function qd(i,e){return e&&(i.sdk=i.sdk||{},i.sdk.name=i.sdk.name||e.name,i.sdk.version=i.sdk.version||e.version,i.sdk.integrations=[...i.sdk.integrations||[],...e.integrations||[]],i.sdk.packages=[...i.sdk.packages||[],...e.packages||[]]),i}function Yd(i,e,t,r){const n=Hl(t),a={sent_at:new Date().toISOString(),...n&&{sdk:n},...!!r&&e&&{dsn:Hn(e)}},s="aggregates"in i?[{type:"sessions"},i]:[{type:"session"},i.toJSON()];return tn(a,[s])}function $d(i,e,t,r){const n=Hl(t),a=i.type&&i.type!=="replay_event"?i.type:"event";qd(i,t&&t.sdk);const s=Xd(i,n,r,e);return delete i.sdkProcessingMetadata,tn(s,[[{type:a},i]])}function rs(i,e,t,r=0){return new jt((n,a)=>{const s=i[r];if(e===null||typeof s!="function")n(e);else{const o=s({...e},t);Je&&s.id&&o===null&&Me.log(`Event processor "${s.id}" dropped event`),On(o)?o.then(l=>rs(i,l,t,r+1).then(n)).then(null,a):rs(i,o,t,r+1).then(n).then(null,a)}})}let Gn,Gl,ns;function Kd(i){const e=Ve._sentryDebugIds;if(!e)return{};const t=Object.keys(e);return ns&&t.length===Gl||(Gl=t.length,ns=t.reduce((r,n)=>{Gn||(Gn={});const a=Gn[n];if(a)r[a[0]]=a[1];else{const s=i(n);for(let o=s.length-1;o>=0;o--){const l=s[o],c=l&&l.filename,u=e[n];if(c&&u){r[c]=u,Gn[n]=[c,u];break}}}return r},{})),ns}function Zd(i,e){const{fingerprint:t,span:r,breadcrumbs:n,sdkProcessingMetadata:a}=e;Jd(i,e),r&&tp(i,r),ip(i,t),Qd(i,n),ep(i,a)}function Vl(i,e){const{extra:t,tags:r,user:n,contexts:a,level:s,sdkProcessingMetadata:o,breadcrumbs:l,fingerprint:c,eventProcessors:u,attachments:h,propagationContext:d,transactionName:f,span:v}=e;Vn(i,"extra",t),Vn(i,"tags",r),Vn(i,"user",n),Vn(i,"contexts",a),i.sdkProcessingMetadata=kn(i.sdkProcessingMetadata,o,2),s&&(i.level=s),f&&(i.transactionName=f),v&&(i.span=v),l.length&&(i.breadcrumbs=[...i.breadcrumbs,...l]),c.length&&(i.fingerprint=[...i.fingerprint,...c]),u.length&&(i.eventProcessors=[...i.eventProcessors,...u]),h.length&&(i.attachments=[...i.attachments,...h]),i.propagationContext={...i.propagationContext,...d}}function Vn(i,e,t){i[e]=kn(i[e],t,1)}function Jd(i,e){const{extra:t,tags:r,user:n,contexts:a,level:s,transactionName:o}=e,l=zt(t);l&&Object.keys(l).length&&(i.extra={...l,...i.extra});const c=zt(r);c&&Object.keys(c).length&&(i.tags={...c,...i.tags});const u=zt(n);u&&Object.keys(u).length&&(i.user={...u,...i.user});const h=zt(a);h&&Object.keys(h).length&&(i.contexts={...h,...i.contexts}),s&&(i.level=s),o&&i.type!=="transaction"&&(i.transaction=o)}function Qd(i,e){const t=[...i.breadcrumbs||[],...e];i.breadcrumbs=t.length?t:void 0}function ep(i,e){i.sdkProcessingMetadata={...i.sdkProcessingMetadata,...e}}function tp(i,e){i.contexts={trace:xd(e),...i.contexts},i.sdkProcessingMetadata={dynamicSamplingContext:Cd(e),...i.sdkProcessingMetadata};const t=Nl(e),r=Qa(t).description;r&&!i.transaction&&i.type==="transaction"&&(i.transaction=r)}function ip(i,e){i.fingerprint=i.fingerprint?Array.isArray(i.fingerprint)?i.fingerprint:[i.fingerprint]:[],e&&(i.fingerprint=i.fingerprint.concat(e)),i.fingerprint&&!i.fingerprint.length&&delete i.fingerprint}function rp(i,e,t,r,n,a){const{normalizeDepth:s=3,normalizeMaxBreadth:o=1e3}=i,l={...e,event_id:e.event_id||t.event_id||Bt(),timestamp:e.timestamp||Qr()},c=t.integrations||i.integrations.map(x=>x.name);np(l,i),op(l,c),n&&n.emit("applyFrameMetadata",e),e.type===void 0&&ap(l,i.stackParser);const u=cp(r,t.captureContext);t.mechanism&&Zi(l,t.mechanism);const h=n?n.getEventProcessors():[],d=nd().getScopeData();if(a){const x=a.getScopeData();Vl(d,x)}if(u){const x=u.getScopeData();Vl(d,x)}const f=[...t.attachments||[],...d.attachments];f.length&&(t.attachments=f),Zd(l,d);const v=[...h,...d.eventProcessors];return rs(v,l,t).then(x=>(x&&sp(x),typeof s=="number"&&s>0?lp(x,s,o):x))}function np(i,e){const{environment:t,release:r,dist:n,maxValueLength:a=250}=e;i.environment=i.environment||t||es,!i.release&&r&&(i.release=r),!i.dist&&n&&(i.dist=n),i.message&&(i.message=Sr(i.message,a));const s=i.exception&&i.exception.values&&i.exception.values[0];s&&s.value&&(s.value=Sr(s.value,a));const o=i.request;o&&o.url&&(o.url=Sr(o.url,a))}function ap(i,e){const t=Kd(e);try{i.exception.values.forEach(r=>{r.stacktrace.frames.forEach(n=>{t&&n.filename&&(n.debug_id=t[n.filename])})})}catch{}}function sp(i){const e={};try{i.exception.values.forEach(r=>{r.stacktrace.frames.forEach(n=>{n.debug_id&&(n.abs_path?e[n.abs_path]=n.debug_id:n.filename&&(e[n.filename]=n.debug_id),delete n.debug_id)})})}catch{}if(Object.keys(e).length===0)return;i.debug_meta=i.debug_meta||{},i.debug_meta.images=i.debug_meta.images||[];const t=i.debug_meta.images;Object.entries(e).forEach(([r,n])=>{t.push({type:"sourcemap",code_file:r,debug_id:n})})}function op(i,e){e.length>0&&(i.sdk=i.sdk||{},i.sdk.integrations=[...i.sdk.integrations||[],...e])}function lp(i,e,t){if(!i)return null;const r={...i,...i.breadcrumbs&&{breadcrumbs:i.breadcrumbs.map(n=>({...n,...n.data&&{data:ui(n.data,e,t)}}))},...i.user&&{user:ui(i.user,e,t)},...i.contexts&&{contexts:ui(i.contexts,e,t)},...i.extra&&{extra:ui(i.extra,e,t)}};return i.contexts&&i.contexts.trace&&r.contexts&&(r.contexts.trace=i.contexts.trace,i.contexts.trace.data&&(r.contexts.trace.data=ui(i.contexts.trace.data,e,t))),i.spans&&(r.spans=i.spans.map(n=>({...n,...n.data&&{data:ui(n.data,e,t)}}))),i.contexts&&i.contexts.flags&&r.contexts&&(r.contexts.flags=ui(i.contexts.flags,3,t)),r}function cp(i,e){if(!e)return i;const t=i?i.clone():new Ai;return t.update(e),t}function up(i){if(i)return hp(i)?{captureContext:i}:pp(i)?{captureContext:i}:i}function hp(i){return i instanceof Ai||typeof i=="function"}const dp=["user","level","extra","contexts","tags","fingerprint","requestSession","propagationContext"];function pp(i){return Object.keys(i).some(e=>dp.includes(e))}function Wl(i,e){return ei().captureException(i,up(e))}function jl(i,e){const t=typeof e=="string"?e:void 0,r=typeof e!="string"?{captureContext:e}:void 0;return ei().captureMessage(i,t,r)}function Xl(i,e){return ei().captureEvent(i,e)}function ql(i){const e=_t(),t=en(),r=ei(),{release:n,environment:a=es}=e&&e.getOptions()||{},{userAgent:s}=Ve.navigator||{},o=Yh({release:n,environment:a,user:r.getUser()||t.getUser(),...s&&{userAgent:s},...i}),l=t.getSession();return l&&l.status==="ok"&&yr(l,{status:"exited"}),Yl(),t.setSession(o),r.setSession(o),o}function Yl(){const i=en(),e=ei(),t=e.getSession()||i.getSession();t&&$h(t),$l(),i.setSession(),e.setSession()}function $l(){const i=en(),e=ei(),t=_t(),r=e.getSession()||i.getSession();r&&t&&t.captureSession(r)}function Kl(i=!1){if(i){Yl();return}$l()}const fp="7";function mp(i){const e=i.protocol?`${i.protocol}:`:"",t=i.port?`:${i.port}`:"";return`${e}//${i.host}${t}${i.path?`/${i.path}`:""}/api/`}function gp(i){return`${mp(i)}${i.projectId}/envelope/`}function _p(i,e){const t={sentry_version:fp};return i.publicKey&&(t.sentry_key=i.publicKey),e&&(t.sentry_client=`${e.name}/${e.version}`),new URLSearchParams(t).toString()}function vp(i,e,t){return e||`${gp(i)}?${_p(i,t)}`}const Zl=[];function xp(i){const e={};return i.forEach(t=>{const{name:r}=t,n=e[r];n&&!n.isDefaultInstance&&t.isDefaultInstance||(e[r]=t)}),Object.values(e)}function Sp(i){const e=i.defaultIntegrations||[],t=i.integrations;e.forEach(s=>{s.isDefaultInstance=!0});let r;if(Array.isArray(t))r=[...e,...t];else if(typeof t=="function"){const s=t(e);r=Array.isArray(s)?s:[s]}else r=e;const n=xp(r),a=n.findIndex(s=>s.name==="Debug");if(a>-1){const[s]=n.splice(a,1);n.push(s)}return n}function yp(i,e){const t={};return e.forEach(r=>{r&&Ql(i,r,t)}),t}function Jl(i,e){for(const t of e)t&&t.afterAllSetup&&t.afterAllSetup(i)}function Ql(i,e,t){if(t[e.name]){Je&&Me.log(`Integration skipped because it was already installed: ${e.name}`);return}if(t[e.name]=e,Zl.indexOf(e.name)===-1&&typeof e.setupOnce=="function"&&(e.setupOnce(),Zl.push(e.name)),e.setup&&typeof e.setup=="function"&&e.setup(i),typeof e.preprocessEvent=="function"){const r=e.preprocessEvent.bind(e);i.on("preprocessEvent",(n,a)=>r(n,a,i))}if(typeof e.processEvent=="function"){const r=e.processEvent.bind(e),n=Object.assign((a,s)=>r(a,s,i),{id:e.name});i.addEventProcessor(n)}Je&&Me.log(`Integration installed: ${e.name}`)}function Mp(i,e,t){const r=[{type:"client_report"},{timestamp:Qr(),discarded_events:i}];return tn(e?{dsn:e}:{},[r])}class ti extends Error{constructor(e,t="warn"){super(e),this.message=e,this.name=new.target.prototype.constructor.name,Object.setPrototypeOf(this,new.target.prototype),this.logLevel=t}}const ec="Not capturing exception because it's already been captured.";class Ep{constructor(e){if(this._options=e,this._integrations={},this._numProcessing=0,this._outcomes={},this._hooks={},this._eventProcessors=[],e.dsn?this._dsn=Nd(e.dsn):Je&&Me.warn("No DSN provided, client will not send events."),this._dsn){const r=vp(this._dsn,e.tunnel,e._metadata?e._metadata.sdk:void 0);this._transport=e.transport({tunnel:this._options.tunnel,recordDroppedEvent:this.recordDroppedEvent.bind(this),...e.transportOptions,url:r})}const t=["enableTracing","tracesSampleRate","tracesSampler"].find(r=>r in e&&e[r]==null);t&&ji(()=>{console.warn(`[Sentry] Deprecation warning: \`${t}\` is set to undefined, which leads to tracing being enabled. In v9, a value of \`undefined\` will result in tracing being disabled.`)})}captureException(e,t,r){const n=Bt();if(Tl(e))return Je&&Me.log(ec),n;const a={event_id:n,...t};return this._process(this.eventFromException(e,a).then(s=>this._captureEvent(s,a,r))),a.event_id}captureMessage(e,t,r,n){const a={event_id:Bt(),...r},s=Wa(e)?e:String(e),o=ja(e)?this.eventFromMessage(s,t,a):this.eventFromException(e,a);return this._process(o.then(l=>this._captureEvent(l,a,n))),a.event_id}captureEvent(e,t,r){const n=Bt();if(t&&t.originalException&&Tl(t.originalException))return Je&&Me.log(ec),n;const a={event_id:n,...t},s=(e.sdkProcessingMetadata||{}).capturedSpanScope;return this._process(this._captureEvent(e,a,s||r)),a.event_id}captureSession(e){typeof e.release!="string"?Je&&Me.warn("Discarded session because of missing or non-string release"):(this.sendSession(e),yr(e,{init:!1}))}getDsn(){return this._dsn}getOptions(){return this._options}getSdkMetadata(){return this._options._metadata}getTransport(){return this._transport}flush(e){const t=this._transport;return t?(this.emit("flush"),this._isClientDoneProcessing(e).then(r=>t.flush(e).then(n=>r&&n))):Ji(!0)}close(e){return this.flush(e).then(t=>(this.getOptions().enabled=!1,this.emit("close"),t))}getEventProcessors(){return this._eventProcessors}addEventProcessor(e){this._eventProcessors.push(e)}init(){(this._isEnabled()||this._options.integrations.some(({name:e})=>e.startsWith("Spotlight")))&&this._setupIntegrations()}getIntegrationByName(e){return this._integrations[e]}addIntegration(e){const t=this._integrations[e.name];Ql(this,e,this._integrations),t||Jl(this,[e])}sendEvent(e,t={}){this.emit("beforeSendEvent",e,t);let r=$d(e,this._dsn,this._options._metadata,this._options.tunnel);for(const a of t.attachments||[])r=Hd(r,Wd(a));const n=this.sendEnvelope(r);n&&n.then(a=>this.emit("afterSendEvent",e,a),null)}sendSession(e){const t=Yd(e,this._dsn,this._options._metadata,this._options.tunnel);this.sendEnvelope(t)}recordDroppedEvent(e,t,r){if(this._options.sendClientReports){const n=typeof r=="number"?r:1,a=`${e}:${t}`;Je&&Me.log(`Recording outcome: "${a}"${n>1?` (${n} times)`:""}`),this._outcomes[a]=(this._outcomes[a]||0)+n}}on(e,t){const r=this._hooks[e]=this._hooks[e]||[];return r.push(t),()=>{const n=r.indexOf(t);n>-1&&r.splice(n,1)}}emit(e,...t){const r=this._hooks[e];r&&r.forEach(n=>n(...t))}sendEnvelope(e){return this.emit("beforeEnvelope",e),this._isEnabled()&&this._transport?this._transport.send(e).then(null,t=>(Je&&Me.error("Error while sending envelope:",t),t)):(Je&&Me.error("Transport disabled"),Ji({}))}_setupIntegrations(){const{integrations:e}=this._options;this._integrations=yp(this,e),Jl(this,e)}_updateSessionFromEvent(e,t){let r=!1,n=!1;const a=t.exception&&t.exception.values;if(a){n=!0;for(const o of a){const l=o.mechanism;if(l&&l.handled===!1){r=!0;break}}}const s=e.status==="ok";(s&&e.errors===0||s&&r)&&(yr(e,{...r&&{status:"crashed"},errors:e.errors||Number(n||r)}),this.captureSession(e))}_isClientDoneProcessing(e){return new jt(t=>{let r=0;const n=1,a=setInterval(()=>{this._numProcessing==0?(clearInterval(a),t(!0)):(r+=n,e&&r>=e&&(clearInterval(a),t(!1)))},n)})}_isEnabled(){return this.getOptions().enabled!==!1&&this._transport!==void 0}_prepareEvent(e,t,r=ei(),n=en()){const a=this.getOptions(),s=Object.keys(this._integrations);return!t.integrations&&s.length>0&&(t.integrations=s),this.emit("preprocessEvent",e,t),e.type||n.setLastEventId(e.event_id||t.event_id),rp(a,e,t,r,this,n).then(o=>{if(o===null)return o;o.contexts={trace:ad(r),...o.contexts};const l=Rd(this,r);return o.sdkProcessingMetadata={dynamicSamplingContext:l,...o.sdkProcessingMetadata},o})}_captureEvent(e,t={},r){return this._processEvent(e,t,r).then(n=>n.event_id,n=>{if(Je){const a=n;a.logLevel==="log"?Me.log(a.message):Me.warn(a)}})}_processEvent(e,t,r){const n=this.getOptions(),{sampleRate:a}=n,s=ic(e),o=tc(e),l=e.type||"error",c=`before send for type \`${l}\``,u=typeof a>"u"?void 0:Pd(a);if(o&&typeof u=="number"&&Math.random()>u)return this.recordDroppedEvent("sample_rate","error",e),Bn(new ti(`Discarding event because it's not included in the random sample (sampling rate = ${a})`,"log"));const h=l==="replay_event"?"replay":l,d=(e.sdkProcessingMetadata||{}).capturedSpanIsolationScope;return this._prepareEvent(e,t,r,d).then(f=>{if(f===null)throw this.recordDroppedEvent("event_processor",h,e),new ti("An event processor returned `null`, will not send event.","log");if(t.data&&t.data.__sentry__===!0)return f;const v=Tp(this,n,f,t);return bp(v,c)}).then(f=>{if(f===null){if(this.recordDroppedEvent("before_send",h,e),s){const m=1+(e.spans||[]).length;this.recordDroppedEvent("before_send","span",m)}throw new ti(`${c} returned \`null\`, will not send event.`,"log")}const v=r&&r.getSession();if(!s&&v&&this._updateSessionFromEvent(v,f),s){const m=f.sdkProcessingMetadata&&f.sdkProcessingMetadata.spanCountBeforeProcessing||0,p=f.spans?f.spans.length:0,w=m-p;w>0&&this.recordDroppedEvent("before_send","span",w)}const x=f.transaction_info;if(s&&x&&f.transaction!==e.transaction){const m="custom";f.transaction_info={...x,source:m}}return this.sendEvent(f,t),f}).then(null,f=>{throw f instanceof ti?f:(this.captureException(f,{data:{__sentry__:!0},originalException:f}),new ti(`Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.
Reason: ${f}`))})}_process(e){this._numProcessing++,e.then(t=>(this._numProcessing--,t),t=>(this._numProcessing--,t))}_clearOutcomes(){const e=this._outcomes;return this._outcomes={},Object.entries(e).map(([t,r])=>{const[n,a]=t.split(":");return{reason:n,category:a,quantity:r}})}_flushOutcomes(){Je&&Me.log("Flushing outcomes...");const e=this._clearOutcomes();if(e.length===0){Je&&Me.log("No outcomes to send");return}if(!this._dsn){Je&&Me.log("No dsn provided, will not send outcomes");return}Je&&Me.log("Sending outcomes:",e);const t=Mp(e,this._options.tunnel&&Hn(this._dsn));this.sendEnvelope(t)}}function bp(i,e){const t=`${e} must return \`null\` or a valid event.`;if(On(i))return i.then(r=>{if(!xr(r)&&r!==null)throw new ti(t);return r},r=>{throw new ti(`${e} rejected with ${r}`)});if(!xr(i)&&i!==null)throw new ti(t);return i}function Tp(i,e,t,r){const{beforeSend:n,beforeSendTransaction:a,beforeSendSpan:s}=e;if(tc(t)&&n)return n(t,r);if(ic(t)){if(t.spans&&s){const o=[];for(const l of t.spans){const c=s(l);c?o.push(c):(Td(),i.recordDroppedEvent("before_send","span"))}t.spans=o}if(a){if(t.spans){const o=t.spans.length;t.sdkProcessingMetadata={...t.sdkProcessingMetadata,spanCountBeforeProcessing:o}}return a(t,r)}}return t}function tc(i){return i.type===void 0}function ic(i){return i.type==="transaction"}function wp(i,e){e.debug===!0&&(Je?Me.enable():ji(()=>{console.warn("[Sentry] Cannot initialize SDK with `debug` option using a non-debug bundle.")})),ei().update(e.initialScope);const t=new i(e);return Ap(t),t.init(),t}function Ap(i){ei().setClient(i)}function Rp(i){const e=[];function t(){return i===void 0||e.length<i}function r(s){return e.splice(e.indexOf(s),1)[0]||Promise.resolve(void 0)}function n(s){if(!t())return Bn(new ti("Not adding Promise because buffer limit was reached."));const o=s();return e.indexOf(o)===-1&&e.push(o),o.then(()=>r(o)).then(null,()=>r(o).then(null,()=>{})),o}function a(s){return new jt((o,l)=>{let c=e.length;if(!c)return o(!0);const u=setTimeout(()=>{s&&s>0&&o(!1)},s);e.forEach(h=>{Ji(h).then(()=>{--c||(clearTimeout(u),o(!0))},l)})})}return{$:e,add:n,drain:a}}const Cp=60*1e3;function Pp(i,e=Date.now()){const t=parseInt(`${i}`,10);if(!isNaN(t))return t*1e3;const r=Date.parse(`${i}`);return isNaN(r)?Cp:r-e}function Lp(i,e){return i[e]||i.all||0}function Up(i,e,t=Date.now()){return Lp(i,e)>t}function Dp(i,{statusCode:e,headers:t},r=Date.now()){const n={...i},a=t&&t["x-sentry-rate-limits"],s=t&&t["retry-after"];if(a)for(const o of a.trim().split(",")){const[l,c,,,u]=o.split(":",5),h=parseInt(l,10),d=(isNaN(h)?60:h)*1e3;if(!c)n.all=r+d;else for(const f of c.split(";"))f==="metric_bucket"?(!u||u.split(";").includes("custom"))&&(n[f]=r+d):n[f]=r+d}else s?n.all=r+Pp(s,r):e===429&&(n.all=r+60*1e3);return n}const Ip=64;function Np(i,e,t=Rp(i.bufferSize||Ip)){let r={};const n=s=>t.drain(s);function a(s){const o=[];if(Bl(s,(h,d)=>{const f=kl(d);if(Up(r,f)){const v=rc(h,d);i.recordDroppedEvent("ratelimit_backoff",f,v)}else o.push(h)}),o.length===0)return Ji({});const l=tn(s[0],o),c=h=>{Bl(l,(d,f)=>{const v=rc(d,f);i.recordDroppedEvent(h,kl(f),v)})},u=()=>e({body:Gd(l)}).then(h=>(h.statusCode!==void 0&&(h.statusCode<200||h.statusCode>=300)&&Je&&Me.warn(`Sentry responded with status code ${h.statusCode} to sent event.`),r=Dp(r,h),h),h=>{throw c("network_error"),h});return t.add(u).then(h=>h,h=>{if(h instanceof ti)return Je&&Me.error("Skipped sending event because buffer is full."),c("queue_overflow"),Ji({});throw h})}return{send:a,flush:n}}function rc(i,e){if(!(e!=="event"&&e!=="transaction"))return Array.isArray(i)?i[1]:void 0}function Op(i,e,t=[e],r="npm"){const n=i._metadata||{};n.sdk||(n.sdk={name:`sentry.javascript.${e}`,packages:t.map(a=>({name:`${r}:@sentry/${a}`,version:Vi})),version:Vi}),i._metadata=n}const Fp=100;function Qi(i,e){const t=_t(),r=en();if(!t)return;const{beforeBreadcrumb:n=null,maxBreadcrumbs:a=Fp}=t.getOptions();if(a<=0)return;const s={timestamp:Qr(),...i},o=n?ji(()=>n(s,e)):s;o!==null&&(t.emit&&t.emit("beforeAddBreadcrumb",o,e),r.addBreadcrumb(o,a))}let nc;const zp="FunctionToString",ac=new WeakMap,Bp=()=>({name:zp,setupOnce(){nc=Function.prototype.toString;try{Function.prototype.toString=function(...i){const e=qa(this),t=ac.has(_t())&&e!==void 0?e:this;return nc.apply(t,i)}}catch{}},setup(i){ac.set(i,!0)}}),kp=Bp,Hp=[/^Script error\.?$/,/^Javascript error: Script error\.? on line 0$/,/^ResizeObserver loop completed with undelivered notifications.$/,/^Cannot redefine property: googletag$/,"undefined is not an object (evaluating 'a.L')",`can't redefine non-configurable property "solana"`,"vv().getRestrictions is not a function. (In 'vv().getRestrictions(1,a)', 'vv().getRestrictions' is undefined)","Can't find variable: _AutofillCallbackHandler",/^Non-Error promise rejection captured with value: Object Not Found Matching Id:\d+, MethodName:simulateEvent, ParamCount:\d+$/],Gp="InboundFilters",Vp=(i={})=>({name:Gp,processEvent(e,t,r){const n=r.getOptions(),a=jp(i,n);return Xp(e,a)?null:e}}),Wp=Vp;function jp(i={},e={}){return{allowUrls:[...i.allowUrls||[],...e.allowUrls||[]],denyUrls:[...i.denyUrls||[],...e.denyUrls||[]],ignoreErrors:[...i.ignoreErrors||[],...e.ignoreErrors||[],...i.disableErrorDefaults?[]:Hp],ignoreTransactions:[...i.ignoreTransactions||[],...e.ignoreTransactions||[]],ignoreInternal:i.ignoreInternal!==void 0?i.ignoreInternal:!0}}function Xp(i,e){return e.ignoreInternal&&Jp(i)?(Je&&Me.warn(`Event dropped due to being internal Sentry Error.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function Uu(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function Du(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Go(),fragmentShader:`
...
#define LOW_PRECISION`),e}function SS(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ac?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===qm?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===hi&&(e="SHADOWMAP_TYPE_VSM"),e}function yS(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wr:case Ar:e="ENVMAP_TYPE_CUBE";break;case $n:e="ENVMAP_TYPE_CUBE_UV";break}return e}function MS(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ar:e="ENVMAP_MODE_REFRACTION";break}return e}function ES(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Lc:e="ENVMAP_BLENDING_MULTIPLY";break;case dg:e="ENVMAP_BLENDING_MIX";break;case pg:e="ENVMAP_BLENDING_ADD";break}return e}function bS(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:r,maxMip:t}}function TS(i,e,t,r){const n=i.getContext(),a=t.defines;let s=t.vertexShader,o=t.fragmentShader;const l=SS(t),c=yS(t),u=MS(t),h=ES(t),d=bS(t),f=dS(t),v=pS(a),x=n.createProgram();let m,p,w=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(gn).join(`
`)),s=Wo(s),s=Yu(s,t),s=$u(s,t),o=Wo(o),o=Yu(o,t),o=$u(o,t),s=Ku(s),o=Ku(o),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
}`;class Ty{constructor(e,t,r,n,a){this.width=r,this.filterCount=n,this.blankCamera=new Io,this.blankCamera.position.z=1,this.makeTexMat=new p_({glslVersion:ra,vertexShader:Ua(Ey),fragmentShader:Ua(by)});const s=2/this.width,o=1/this.width,l=new Float32Array({length:this.width**2*3});let c=0;for(let u=0;u<this.width;u++)for(let h=0;h<this.width;h++)l[c++]=h*s+o-1,l[c++]=u*s+o-1,l[c++]=0;this.makeTexMeshs=[];for(let u=0;u<this.filterCount;u++){const h=new bi;h.setAttribute("position",new Dt(l,3)),h.setAttribute("wavePosition",e[u]),h.setAttribute("wavePartial",t[u]),this.makeTexMeshs.push(new d_(h,this.makeTexMat))}this.renderTargets=new Array(this.filterCount).fill(0).map(()=>new Ui(this.width,this.width,{count:3,magFilter:a?kt:At,minFilter:At,depthBuffer:!1,stencilBuffer:!1,type:ii,generateMipmaps:!0,wrapS:tr,wrapT:tr,format:Ht}))}render(e){if(!this.makeTexMeshs[0].geometry.attributes.wavePosition.array)throw new Error("Geometry attributes not updated!");for(let t=0;t<this.filterCount;t++)e.setRenderTarget(this.renderTargets[t]),e.render(this.makeTexMeshs[t],this.blankCamera)}getDisplacementTexs(){return this.renderTargets.map(e=>e.textures[0])}getFirstMomentTexs(){return this.renderTargets.map(e=>e.textures[1])}getSecondMomentTexs(){return this.renderTargets.map(e=>e.textures[2])}}class wy{constructor(e){this.p=e,this.target=[0,0],this.current=[0,0],this.lastTime=Date.now()}easeOutCirc(e){return Math.sqrt(1-Math.pow(e-1,2))}pushValue(e){(this.target[0]!==e[0]||this.target[1]!==e[1])&&(this.target=e)}getValue(){const e=Date.now(),t=e-this.lastTime;this.lastTime=e;const r=[this.target[0]-this.current[0],this.target[1]-this.current[1]];if(r[0]==0&&r[1]==0)return this.target;const n=[r[0]*this.p,r[1]*this.p];return this.current=[this.current[0]+n[0]*t,this.current[1]+n[1]*t],this.current}}var Ay=`#version 300 es
